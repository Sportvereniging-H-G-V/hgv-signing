...
module Submissions
  module GenerateCombinedAttachment
    ...
    def call(submitter)
      ...
      if pkcs
        sign_params = Submissions::GenerateResultAttachments.build_signing_params(submitter, pkcs, tsa_url).merge(
      ...
      ActiveStorage::Attachment.create!(
        blob: ActiveStorage::Blob.create_and_upload!(
          io: io, filename: "#{submission.name || submission.template.name}.pdf"
        ),
