...
class TemplatesDashboardController < ApplicationController
  ...
  def index
    # Laad resources handmatig met accessible_by om authorization te respecteren zonder exceptions
    @template_folders = TemplateFolder.accessible_by(current_ability)
