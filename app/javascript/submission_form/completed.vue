<template>
  ...
  >
    ...
    <div
      v-if="hasSignatureFields && !completedMessage.body"
      class="mt-4 text-center completed-form-message-body"
    >
      <p>{{ t('document_signed_processing_message') }}</p>
    </div>
    <div
      v-else-if="completedMessage.body"
