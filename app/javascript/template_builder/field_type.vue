  ...
  >
    ...
    >
      <template
        ...
        :key="type"
      >
        <li v-if="fieldTypes.includes(type) || ((withPayment || type != 'payment') && (withVerification || type != 'verification'))">
          <a
            href="#"
...
<script>
import { IconTextSize, IconWritingSign, IconCalendarEvent, IconCheckbox, IconSelect, IconCircleDot, IconChecks, IconColumns3, IconPhoneCheck, IconLetterCaseUpper, IconCreditCard, IconRubberStamp, IconSquareNumber1, IconHeading, IconId, IconCalendarCheck, IconStrikethrough } from '@tabler/icons-vue'
...
export default {
  ...
  computed: {
    ...
    skipTypes () {
      return ['heading', 'datenow', 'strikethrough', 'image', 'file']
    },
    fieldIconsSorted () {
