...
const es = {
  ...
  not_empty: 'No vacío',
  empty: 'Vacío',
  age_less_than: 'Edad menor que',
  age_greater_than: 'Edad mayor que',
...
const it = {
  ...
  not_empty: 'Non vuoto',
  empty: 'Vuoto',
  age_less_than: 'Età inferiore a',
  age_greater_than: 'Età superiore a',
  age_in_years: 'Età in anni',
...
const pt = {
  ...
  not_empty: 'Não vazio',
  empty: 'Vazio',
  age_less_than: 'Idade menor que',
  age_greater_than: 'Idade maior que',
...
const fr = {
  ...
  not_empty: 'Non vide',
  empty: 'Vide',
  age_less_than: 'Âge inférieur à',
  age_greater_than: 'Âge supérieur à',
...
const de = {
  ...
  empty: 'Leer',
  age_less_than: 'Alter unter',
  age_greater_than: 'Alter über',
...
const nl = {
  ...
  not_empty: 'Niet leeg',
  empty: 'Leeg',
  age_less_than: 'Leeftijd jonger dan',
  age_greater_than: 'Leeftijd ouder dan',
  age_in_years: 'Leeftijd in jaren',
